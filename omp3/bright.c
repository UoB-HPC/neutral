...
void update_tallies(
    const int index, const int nx, const int x_off, const int y_off, Particles* particles, 
    ...
    double* energy_deposition_tally)
{
  ...
  const int cellx = particles->cellx[index]-x_off;
  const int celly = particles->celly[index]-y_off;
